 ...
 * @author 		ispCP Team
 * @version 	SVN: $Id: Database.php 3852 2011-06-11 00:14:06Z benedikt $
...
class EasySCP_Update_Database extends EasySCP_Update {
	 ...
	 * for convenience reasons in the easyscp-htaccess-mngr engine script.
	 *
	 * @author Laurent Declercq <laurent.declercq@ispcp.net>
	 * @since r2698
	 * @return array SQL statements to be performed
	...
	protected function _databaseUpdate_43() {
		...
		$cfg = new EasySCP_Config_Handler_File();
