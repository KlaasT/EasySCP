 ...
 * @version 	SVN: $Id: Base.php 3006 2010-06-17 06:35:32Z nuxwin $
 *
 * @license
...
define('EasySCP_LOG_ERROR', 	0);
define('EasySCP_LOG_WARNING',	1);
define('EasySCP_LOG_INFO',	2);
define('EasySCP_LOG_DEBUG',	3);
...
abstract class BaseController
{
	 ...
	 * current log level
	 */
	public $log_level = EasySCP_LOG_ERROR;
	/**
	 ...
	 * @param integer $level log level (see literals EasySCP_LOG_*)
	 */
	protected function logMessage($message, $level = EasySCP_LOG_ERROR)
	{
	    if ($this->log_level >= $level) {
	        echo $message . "\n";
			flush();
	    }
	    if ($level == EasySCP_LOG_ERROR) {
	    	$this->errorCount++;
	    }
	}
	...
	{
		$this->logMessage($cmd, EasySCP_LOG_INFO);
		return exec($cmd, $a);
	}
