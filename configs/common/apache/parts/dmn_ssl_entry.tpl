<VirtualHost {DMN_IP}:443>
    SSLEngine On
    SSLCertificateFile    {WWW_DIR}/{DMN_NAME}/certs/{DMN_NAME}.cert
    SSLCertificateKeyFile {WWW_DIR}/{DMN_NAME}/certs/{DMN_NAME}.key
    ServerName            {DMN_NAME}:443
    ...
    RedirectMatch permanent ^/easyscp[\/]?$	{BASE_SERVER_VHOST_PREFIX}{BASE_SERVER_VHOST}/
